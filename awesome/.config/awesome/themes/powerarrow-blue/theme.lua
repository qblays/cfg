...
theme.weather = lain.widget.weather({
    city_id = 472757, -- placeholder (Volgograd)
...
function theme.at_screen_connect(s)
   ...
   s.quake = lain.util.quake({ app = "termite", height = 0.50, argname = "--name %s" })
	...
	-- charitable create a special scratch tag for double buffering
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            ...
            --arrow("#7197E7", "#A77AC4"),
            --wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 6, 6), "#A77AC4"),
            --arrow("#A77AC4", "#7197E7"),
            arrow("#7197E7", "#A77AC4"),
